...
"""
    function predict(model::MySisoLegSHippoModel, tspan::NamedTuple, signal::Array{Float64,1}; L::Int64 = 10) -> Tuple
...
"""
    function learn(model::MySisoLegSHippoModel, tspan::NamedTuple, signal::Array{Float64};
...
function learn(model::MySISOLegSHiPPOModel, tspan::NamedTuple, 
